...
describe('ProductListComponent', () => {
  ...
  beforeEach(async () => {
    ...
    jest.spyOn(productService, 'getAllProducts').mockImplementation(productService.getAllProducts);
    jest.spyOn(productService, 'deleteProduct').mockImplementation(productService.deleteProduct);
  });
  ...
  describe('loadProducts', () => {
    it('should load products and filter them', () => {
      ...
      jest.spyOn(productService, 'getAllProducts').mockReturnValue(of({ data: mockProducts }));
    ...
    it('should handle error when loading products', () => {
      jest.spyOn(productService, 'getAllProducts').mockReturnValue(throwError(() => new Error('Error')));
